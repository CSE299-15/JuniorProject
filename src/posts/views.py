...
def like_unlike_post(request):
    """
    This method will create a like or unlike request on posts and upon successfull insertion,
    it will update the like or unlike. If the post status is liked will update it to unliked 
    otherwise update it to liked. If the post previouly existed and its status is liked then 
    will update it to unliked othwise will update it to liked.
    This method will only load this page if the user is logged in.
...
class PostDeleteView(DeleteView):
    """
    PostDeleteView inherits from the DeleteView. These allow you to structure your views and 
    ...
    def get_object(self, *args, **kwargs):
        ...
        then that particular user will able to delete the post, first that particular user will able
        to go into given template link and able to delete the post and will get back to the attached 
        success url page after deletation. However if the user is not the owner of the post then the
        user will not be able to delete the post even if he has the url of the post. For this case it 
...
class PostUpdateView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        the user will not be able to update the post even if he has the url of the post. For this case it 
        will show a error message. 
